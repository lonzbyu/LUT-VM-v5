...
<xsl:stylesheet version="1.0" exclude-result-prefixes="tei"
   ...
   <!-- IMPORT SETTINGS -->
   <xsl:include href="settingsDWL.xsl"/>
   ...
   <xsl:template name="mainBanner">
      <div id="mainBanner">
         ...
         <div id="bannerImageContainer">
            ...
            <img id="logo" alt="Powered by the Versioning Machine" src="../../vm-images/HeaderBackground.png"/>
   ...
   <xsl:template name="brandingLogo">
      <div id="brandingLogo">
         <a href="{$logoLink}">
            <img id="logo" alt="Powered by the Versioning Machine" src="../../vm-images/LogoSilver.png"/>
         </a>
      </div>
   </xsl:template>
